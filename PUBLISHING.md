# Publishing Guide: Nazarf's Claude Code Plugin
...
- [ ] Repository renamed to `nazarf-claude-code` ✅
...
2. Fill in the details:
   - **Repository name**: `nazarf-claude-code`
   - **Description**: "Nazarf's personal Claude Code setup with 14 productivity commands and 11 specialized AI agents for modern web development"
...
```bash
cd ~/IdeaProjects/nazarf-claude-code

# Add the GitHub remote
git remote add origin https://github.com/norens/nazarf-claude-code.git
...
/plugin install norens/nazarf-claude-code
...
Your README already includes your GitHub username `norens`, so users can copy-paste commands directly!
...
```json
{
  "name": "nazarf-claude-code",
  "source": "norens/nazarf-claude-code",
...
GitHub: https://github.com/norens/nazarf-claude-code
```
...
```bash
/plugin update nazarf-claude-code
```
...
1. Go to your repo: https://github.com/norens/nazarf-claude-code
...
```bash
/plugin install norens/nazarf-claude-code@v1.0.0
```
